...
//         IL_Player.InternalSavePlayerFile += SSCSave;
...
//
//
//     public static TagCompound tagcache;
//     
//     void SSCSave(ILContext il)
//     {
//     
//         var cur = new ILCursor(il);
//         cur.GotoNext(MoveType.After, i => i.MatchCall("Terraria.ModLoader.PlayerIO","SaveData"));
//         cur.EmitDelegate<Func<TagCompound, TagCompound>>(tag =>
//         {
//             tagcache = tag;
//             return tag;
//         });
...
//         
//         
//         // IL_00ad: ldloc.1      // player
//         // IL_00ae: call         class Terraria.ModLoader.IO.TagCompound Terraria.ModLoader.IO.PlayerIO::SaveData(class Terraria.Player)
//         // IL_00b3: ldloc.0      // path1
//         // IL_00b4: ldloc.2      // isCloudSave
//         // IL_00b5: call         void Terraria.ModLoader.BackupIO/Player::ArchivePlayer(string, bool)
//         // IL_00ba: ldloc.0      // path1
//         // IL_00bb: ldloc.2      // isCloudSave
//         // IL_00bc: call         bool Terraria.Utilities.FileUtilities::Exists(string, bool)
//         // IL_00c1: brfalse.s    IL_00d6
//         
//         
//         
//         
